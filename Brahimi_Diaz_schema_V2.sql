...
CREATE TABLE IF NOT EXISTS `client` (
  ...
  PRIMARY KEY (`codeClient`), constraint ck_titre_valide CHECK(`titre` IN ('Mlle','M.','Mme')))
  ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `livre` (
  ...
  `codeCategorie` CHAR(2) NULL,
  `descriptif` TEXT NULL,
  `prixCatalogue` DECIMAL(10,2) NULL,
  `nbrePages` SMALLINT(5) UNSIGNED NULL,
